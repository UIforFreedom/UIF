    ...
    <el-card class="box-card" v-if="!isSimple">
      ...
      <el-form label-width="100px">
        <el-row :gutter="5">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
            <el-tooltip :disabled="uif.showToolTip" placement="top">
              <div slot="content">设置内存触发GC频率</div>
              <el-form-item
              ...
              >
                ...
                >
                  <el-option
                    :label="$translator({ cn: '无限制', en: 'Do not Set' })"
                    value="0"
                  ></el-option>
                  <el-option
                    :label="$translator({ cn: '50MB', en: '50MB' })"
                    value="50MB"
                  ></el-option>
                  <el-option
                    :label="$translator({ cn: '100MB', en: '100MB' })"
                    value="100MB"
                  ></el-option>
                  <el-option
                    :label="$translator({ cn: '300MB', en: '300MB' })"
                    value="300MB"
                  ></el-option>
                  <el-option
                    :label="$translator({ cn: '1GB', en: '1GB' })"
                    value="1GB"
                  ></el-option>
                </el-select>
              </el-form-item>
