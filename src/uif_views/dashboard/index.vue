  ...
  <div class="app-container">
    ...
    <el-card class="box-card" v-loading="uif.connection.isConnecting">
      <div slot="header" class="clearfix">
        ...
        <i
          :class="CheckVersion1() ? 'el-icon-null' : 'el-icon-warning'"
          :style="{ color: CheckVersion1() ? 'black' : 'red' }"
        >
          {{ CheckVersion() }}
        </i>
        <el-divider direction="vertical"></el-divider>
...
export default {
  ...
  methods: {
    ...
    CheckVersion() {
      if (this.CheckVersion1()) {
        return this.uif.connection.web_version;
      }
      return "Web 版本不一致";
    },
    CheckVersion1() {
      var c = this.uif.connection;
      if (!c.isConnected || c.version == c.web_version) {
        return true;
      }
      return false;
    },
