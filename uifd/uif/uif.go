...
func ProxyGetWithConfig(config string, proxyAddress bool) string {
...
func GetNewestCoreVersion() string {
	res, _ := HTTPGetProxy("https://raw.githubusercontent.com/UIforFreedom/UIF/master/uifd/version/core.txt")
	res = strings.Split(res, "\n")[0]
	return res
}

func GetNewestUIFVersion() string {
	res, _ := HTTPGetProxy("https://raw.githubusercontent.com/UIforFreedom/UIF/master/uifd/version/uif.txt")
	res = strings.Split(res, "\n")[0]
	return res
}
...
func GetPublicIP() string {
	if MyPublicIP == "" {
		resp, err := HTTPGetDirect("https://api.ipify.org?format=json")
		if err != nil {
			MyPublicIP = "0.0.0.0"
		} else {
			if err != nil {
...
func GetCoreStatus() int64 {
	...
	if CoreProcess.ProcessState == nil {
		return 0 // running
	}
	return 1 // closed
}
...
func CloseCore() {
	...
	if CoreProcess == nil || CoreProcess.ProcessState != nil && CoreProcess.ProcessState.Exited() {
		return
	}
